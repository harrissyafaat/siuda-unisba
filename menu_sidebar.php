...
<?php
$link = "http://$_SERVER[HTTP_HOST]/wisuda";
echo "<li class='active'><a style='font-size: 12px;' href='$link'>Beranda</a></li>";
echo "<li><a style='font-size: 12px;' href='jadwal.php'>Jadwal Pendaftaran Wisuda</a></li>";
